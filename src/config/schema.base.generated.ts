                ...
                properties: {
                  ...
                  style: {
                    ...
                    properties: {
                      tone: {
                        type: "string",
                        enum: ["neutral", "warm", "playful", "dry", "formal"],
                      },
                      directness: {
                        type: "string",
                        enum: ["soft", "balanced", "direct"],
                      },
                      verbosity: {
                        type: "string",
                  ...
                  authority: {
                    ...
                    properties: {
                      stance: {
                        type: "string",
                        enum: ["collaborative", "advisor", "operator"],
                      },
                      confidence: {
                        type: "string",
                  ...
                  channels: {
                    ...
                    additionalProperties: {
                      ...
                      properties: {
                        ...
                        responseStyle: {
                          type: "string",
                          enum: ["plain", "structured", "bullet-first"],
                        },
                      },
                      additionalProperties: false,
                    },
