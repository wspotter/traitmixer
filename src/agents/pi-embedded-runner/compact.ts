...
import { compilePersonalityOverlay, resolvePersonalityConfig } from "../personality-overlay.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  try {
    ...
    const personalityOverlay = compilePersonalityOverlay(
      resolvePersonalityConfig(params.config, sessionAgentId, runtimeChannel),
      { channel: runtimeChannel },
    );
