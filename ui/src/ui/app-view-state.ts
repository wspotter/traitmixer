...
export type AppViewState = {
  ...
  agentsPanel: "overview" | "personality" | "files" | "tools" | "skills" | "channels" | "cron";
  agentPersonalityTarget: "agent" | "defaults";
  agentPersonalityChannel: string;
  agentPersonalityMode: PersonalityPreviewMode;
  agentPersonalityProfileId: string;
