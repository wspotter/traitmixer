...
export type AgentsProps = {
  ...
  onPersonalityTargetChange: (target: PersonalityTarget) => void;
  onPersonalityChannelChange: (channel: string) => void;
  onPersonalityModeChange: (mode: PersonalityPreviewMode) => void;
  onPersonalityProfileChange: (profileId: string) => void;
  onPersonalityProfileSave: (params: { agentId: string }) => void;
  onPersonalityProfileApply: (params: { agentId: string; profileId: string }) => void;
  onPersonalityProfileDelete: (profileId: string) => void;
  onPersonalityProfileRename: (params: { profileId: string; name: string }) => void;
  onPersonalityFieldChange: (params: {
    agentId: string;
    target: PersonalityTarget;
    path: string[];
    value: string | null;
        ...
        ${!selectedAgent
          ...
          : html`
              ...
              ${props.activePanel === "overview"
                ...
                : nothing}
              ${props.activePanel === "personality"
                ? renderAgentPersonality({
                    agentId: selectedAgent.id,
                    configForm: props.config.form,
                    configLoading: props.config.loading,
                    configSaving: props.config.saving,
                    configApplying: props.config.applying,
                    configDirty: props.config.dirty,
                    channelSnapshot: props.channels.snapshot,
                    target: props.personality.target,
                    channel: props.personality.channel,
                    mode: props.personality.mode,
                    profileId: props.personality.profileId,
                    profiles: props.personality.profiles,
                    onTargetChange: props.onPersonalityTargetChange,
                    onChannelChange: props.onPersonalityChannelChange,
                    onModeChange: props.onPersonalityModeChange,
                    onProfileChange: props.onPersonalityProfileChange,
                    onProfileSave: () =>
                      props.onPersonalityProfileSave({ agentId: selectedAgent.id }),
                    onProfileApply: (profileId) =>
                      props.onPersonalityProfileApply({ agentId: selectedAgent.id, profileId }),
                    onProfileRename: props.onPersonalityProfileRename,
                    onProfileDelete: props.onPersonalityProfileDelete,
                    onFieldChange: (params) =>
                      props.onPersonalityFieldChange({
                        ...params,
                        agentId: selectedAgent.id,
                      }),
                    onConfigReload: props.onConfigReload,
